  ...
  class HoverImgFx12 {
    constructor(el) {
      ...
      this.DOM.revealDecos = [
        ...this.DOM.reveal.querySelectorAll(".hover-reveal__deco"),
      ];
      this.DOM.revealDecos.forEach((deco, pos) => {
        TweenMax.set(deco, {
          width:
            pos === this.totalDecos - 1
              ? "100%"
              : `${getRandomFloat(40, 100)}%`,
          height:
            pos === this.totalDecos - 1 ? "100%" : `${getRandomFloat(5, 30)}%`,
          x:
            pos === this.totalDecos - 1
              ? "0%"
    ...
    showImage() {
      ...
      const loop = () => {
        this.imgtimeout = setTimeout(() => {
          ...
          this.current =
            this.current < this.imgsTotal - 1 ? this.current + 1 : 0;
          show();
          loop();
        }, 500);
      };
  ...
  class HoverImgFx15 {
    ...
    showImage() {
      ...
      for (let i = 0; i <= this.totalImages - 1; ++i) {
        ...
        this.tl.add(
          new TweenMax(
            this.DOM.revealImgs[i],
            i === this.totalImages - 1 ? 1.2 : 0.55,
            {
